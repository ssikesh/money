import 'package:moneymatters/helpers/color.helper.dart';
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Money Matters", style: theme.textTheme.headlineLarge!.apply(color: theme.colorScheme.primary, fontWeightDelta: 1),),
